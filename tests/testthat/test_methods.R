...
test_that("print, summary and compare methods work correctly", {
  ...
  expect_output(compare(mod1, mod2, mod3), "hillslope")
  expect_output(compare(mod_multi), "power2")
  ...
  expect_output(compare(mod_cv, mod_cv), "hillslope")
  expect_output(compare(mod_cv_multi), "power2")
})
...
test_that("plot methods work correctly", {
  ...
  expect_warning(plot(mod_cv_multi))
})
